! function o(r, a, u) {
    ...
    2: [function(e, t, i) {
        ...
        i.EMPTY_WIDGET_ID = "000000000000000000000000", i.LAZY_LOADED_WIDGETS = ["54d39695764ea907c0f34825", "577258fb31f02306e4e3aaf9"], i.OFF = "off"
    }, {}],
    3: [function(e, t, i) {
        "use strict";
        var n = !1;
        ...
        t.exports = function(e) {
            ...
            return e.schemaType && e.location ? (function(e) {
                var t = e.businessunitId,
                    ...
                    n = e.locale,
                    s = e.templateId,
                    o = "https://widget.trustpilot.com" + ("/data/jsonld/business-unit/" + t + "/location/" + i) + "?" + ["url=" + encodeURIComponent(window.location.href), "templateId=" + s, "locale=" + n].join("&");
                m.xhrGet({
                    url: o,
                    success: function(e) {
                ...
                var t = e.businessunitId,
                    ...
                    l = e.availability,
                    d = i && i.split("-")[0],
                    c = "https://widget.trustpilot.com" + ("5763bccae0a06d08e809ecbb" === n ? "/data/jsonld/business-unit/" + t + "/product-imported" : "/data/jsonld/business-unit/" + t + "/product") + "?sku=" + encodeURIComponent(o) + "&numberOfReviews=" + (r || 10) + (s ? "&productName=" + s : "") + "&language=" + d + "&templateId=" + n + "&url=" + encodeURIComponent(window.location.origin + window.location.pathname),
                    h = a && u && l ? {
                        "@type": "Offer",
                        priceCurrency: u,
                        price: a,
        ...
        var c = (n(h, [{
            ...
            value: function(e) {
                if (this.removeWidget(e), this.checkWidgetDisplayAndUpdateDataset(e)) {
                    var t = e.dataset;
                    (0, r.default)(t);
                    var i = "group" in t && this.abSettings,
                        n = i ? {
                            container: e,
                            dataset: t,
    ...
    5: [function(e, t, i) {
        ...
        function l(e, t, i) {
            ...
            ! function(e, t) {
                if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
            }(this, l), this.OVERFLOW_PROPERTIES = ["overflow", "overflow-x", "overflow-y"], this.name = e, this.dataset = t, this.iframeData = i || this.defaultIframeOptions, this.defaultOverflowProperties = {}, this.isVisible = !1, this.isScrollBlocking = n
        }
        i.default = u
    }, {}],
    6: [function(e, t, i) {
        ...
        var a = (n(c, null, [{
            ...
            value: function(e) {
                var t = 0 < arguments.length && void 0 !== e ? e : 200,
                    i = this.container.getBoundingClientRect(),
                    n = i.width || this.container.offsetWidth,
                    s = i.height || this.container.offsetHeight;
            ...
            value: function(e, t) {
                var i = this,
                    n = 1 < arguments.length && void 0 !== t ? t : function() {};
            ...
            value: function(e, t, i) {
                var n = this,
                    ...
                    o = new r.default(e, this.dataset, t, s);
            ...
            value: function(e) {
                var t = 0 < arguments.length && void 0 !== e ? e : [],
                    i = document.querySelector(t.map(function(e) {
            ...
            try {
                ...
                ! function() {
                    function e(e) {
                        ...
                        var t = ["error=" + encodeURIComponent(e), "uri=" + encodeURIComponent(document.URL), "bootstrapVersion=" + i].join("&");
