(function() {
    ...
    */
    ...
    var Na = Ca(function() {
            return oa(["Google Web Preview", "Mediapartners-Google", "Google-Read-Aloud", "Google-Adwords"], Ma) || 1E-4 > Math.random()
        }),
        Oa = Ca(function() {
            return Ma("MSIE")
        });
    ...
    function Pa(a, b) {
        ...
        a = String(a);
        var c;
        "application/xhtml+xml" === (null == (c = b) ? void 0 : c.contentType) && (a = a.toLowerCase());
        return b.createElement(a)
    };
    var Qa = ja("0.20"),
        Ra = ja("0.002"),
    ...
    function $a(a, b, c) {
        ...
        if (c ? d.g.hasOwnProperty(c) && "" == d.g[c] : 1) {
            var e;
            e = (e = Za()) ? (e = e.match(new RegExp("\\b(" + a.join("|") + ")\\b"))) ? e[0] : null : null;
            if (e) a = e;
            else a: {
    ...
    function zb(a, b, c) {
        ...
        if (wb(c.o)) {
            ...
            } else h && "none" !== h.toLowerCase() && (f = d(f, "domain", h)), f = e(f, c.flags), Cb(h, c.path) || yb(f, a, b, c.o)
        }
    }
    ...
    function Kb(a, b) {
        var c = "query";
        if ("protocol" === c || "port" === c) a.protocol = Lb(a.protocol) || Lb(I.location.protocol);
        "port" === c ? a.port = String(Number(a.hostname ? a.port : I.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")) : "host" === c && (a.hostname = (a.hostname || I.location.hostname).replace(Ib, "").toLowerCase());
        var d = Lb(a.protocol);
    ...
    function Qb(a, b) {
        rb("ad_storage") ? Q() ? a() : ub(a) : b ? lb(3) : tb(function() {
            Qb(a, !0)
        })
    }
    ...
    function R(a) {
        var b = [];
        if ("null" === I.origin || !J.cookie) return b;
        a = vb(a, J.cookie, void 0, "ad_storage");
        ...
        for (var c = {}, d = 0; d < a.length; c = {
            ...
            if (null != e) {
                ...
                h ? (h.timestamp = Math.max(h.timestamp, g), h.labels = Tb(h.labels, f || [])) : b.push({
                    version: e,
                    h: c.j,
                    timestamp: g,
                    labels: f
    ...
    function $b(a, b, c, d, e) {
        ...
        a.ha && g("ha", f(a.ha[0]));
        a.gp && g("gp", f(a.gp[0]));
        if ((void 0 == Mb.enable_gbraid_cookie_write ? 0 : Mb.enable_gbraid_cookie_write) && !m && a.gb) {
            a = a.gb[0];
            d =
                ac("gb", h);
            c = !1;
            if (!b)
                for (b = R(d), d = 0; d < b.length; d++) b[d].h === a && b[d].labels && 0 < b[d].labels.length && (c = !0);
            c || g("gb", f(a))
        }
    }
    ...
    function dc() {
        var a = ["aw"],
            b = {};
        if ("null" !== I.origin) {
            for (var c = Wb(b.prefix), d = {}, e = 0; e < a.length; e++) Pb[a[e]] && (d[a[e]] = Pb[a[e]]);
            Qb(function() {
                hb(d, function(f, g) {
                    g = vb(c + g, J.cookie, void 0, "ad_storage");
                    g.sort(function(n, p) {
                        return bc(p) - bc(n)
                    });
                    if (g.length) {
    ...
    function ec(a, b, c, d) {
        ...
        if (d) return e;
        1 !== e[0] && (d = f[0], f = f[0].timestamp, b = [d.version, Math.round(f / 1E3), d.h].concat(d.labels || [], [b]).join("."), c = Gb(c, f), c.o = "ad_storage", Db(a, b, c));
        return e
    }
    ...
    function tc(a, b) {
        var c = "" !== sc(a, b) || 0 < w(Object, "keys").call(Object, Q() ? P("_gac_gb", !0) : {}).length;
        a = "" !== rc(a, b) || "" !== oc(a, Q() ? P() : {}, kc);
        return c && a
    }

    function uc(a) {
        0 !== Rb("_gcl_aw").length || a && 0 !== Rb(a + "_aw").length || (Zb(), dc())
    }
    ...
    function Dc() {
        var a = K(yc);
        return w(Object, "values").call(Object, xc).map(function(b) {
            return [b, a.g[b] || 0]
        })
    };
    ...
    function Yc(a, b, c, d, e, f) {
        ...
        var ld = T("guid", "ON"),
            md = !d.google_conversion_domain && "GooglemKTybQhCsO" in A && "function" == typeof A.GooglemKTybQhCsO ? T("resp",
                "GooglemKTybQhCsO") : "",
        ...
        if (a) {
            var F = a.screen;
            F && (v.push(T("u_h", F.height)), v.push(T("u_w", F.width)), v.push(T("u_ah", F.availHeight)), v.push(T("u_aw", F.availWidth)), v.push(T("u_cd", F.colorDepth)));
            a.history && v.push(T("u_his", a.history.length))
        }
        X && "function" == typeof X.getTimezoneOffset && v.push(T("u_tz", -X.getTimezoneOffset()));
        b && ("function" == typeof b.javaEnabled && v.push(T("u_java", b.javaEnabled())),
            b.plugins && v.push(T("u_nplug", b.plugins.length)), b.mimeTypes && v.push(T("u_nmime", b.mimeTypes.length)));
        X = v.join("");
        v = T("gtm", d.google_gtm);
        b = b && b.sendBeacon ? T("sendb", "1") : "";
        F = Zc();
        var qd = T("ig", /googleadservices\.com/.test("www.googleadservices.com") ? 1 : 0),
            ta = Tc(d.google_custom_params);
        f = Tc(f);
        ...
        if (c) {
            if (a.top == a) var r =
                ...
                if (H) r = H[H.length - 1] == a.location.origin ? 1 : 2;
                else {
                    H = a.top;
                    try {
                        var z;
                        if (z = !!H && null != H.location.href) c: {
                            try {
                                Da(H.foo);
                                z = !0;
                                break c
            ...
            ua += T("frm", r);
            ua += T("url", Rc(z));
            ua += T("ref", Rc(rd || c.referrer))
        }
        a = [h, k, m, n, p, q, u, C, W, gd, hd, id, jd, kd, x, ld, md, nd, od, X, v, b, F, qd, f, ta, ua, Xc(c), $c(d.google_additional_params), $c(d.google_remarketing_only ? {} : d.google_additional_conversion_params),
            "&hn=" + S("www.googleadservices.com"), ad(a)
        ].join("");
        c = Za();
            ...
            if (d)
                if (r = d.google_conversion_items) {
                    ...
                    for (k = r.length; h < k; h++) m = r[h], n = [], m && (n.push(U(m.value)), n.push(U(m.quantity)), n.push(U(m.item_id)),
                        n.push(U(m.start_date)), n.push(U(m.end_date)), z.push("(" + n.join("*") + ")"));
    ...
    function ed(a, b) {
        G && "376635471" == ab(2) && ("complete" === b.readyState ? bd(b) : a.addEventListener ? a.addEventListener("load", function() {
            bd(b)
    ...
    function vd(a, b) {
        ...
        b ? (Oc = !0, a = jb("conversion-measurement") || jb("attribution-reporting")) : a = !1;
        return a
    };
    var wd = !1,
            ...
            if (!wd && (wd = !0, !c.google_gtm)) {
                ...
                if (d) {
                    ...
                    if (!a["google.tagmanager.debugui2.queue"]) {
                        ...
                        var m = wa(k instanceof ka && k.constructor === ka && k.g === ma ? k.i : "type_error:Const");
                        c = {
                            id: h,
                            src: "LEGACY",
                            cond: d
                        };
                        var n = va.exec(sa(m).toString()),
                            p = n[3] || "";
    ...
    function Ad(a, b) {
        a.onload_callback && "function" == typeof a.onload_callback.call ? a.onload_callback = Qc(b, a.onload_callback) : a.onload_callback = function() {}
    }
    ...
    function Bd(a, b, c, d) {
        ...
        try {
            if (fd(d)) {
                d.google_remarketing_only && d.google_enable_display_cookie_match && !Kc && G && $a(["376635470", "376635471"], Qa, 2);
                d.google_remarketing_only && !d.google_conversion_domain && G && $a(["759238990", "759238991"], Ta, 13);
                !d.google_remarketing_only || d.google_conversion_domain || G && ("759248991" == ab(14) || "759248990" == ab(14)) || G && $a(["759248990", "759248991"], Sa, 14);
                ...
                if (1 == d.google_remarketing_only && null != d.google_gtag_event_data && null != d.google_gtag_event_data.items && d.google_gtag_event_data.items.constructor === Array && 0 < d.google_gtag_event_data.items.length) Cd(a, b, c, d);
                    ...
                    d.google_remarketing_only ? h(2) : g ? (Ad(d, f ? 3 : 2), ud(a, b, c, d), h(1), h(3), f && h(6, !0, !1)) : (Ad(d, f ? 2 : 1), ud(a, b, c, d), h(0), f && h(5, !0, !1), Wc(d) && tc(c, Vc(d)) && (d.l = !0, h(0, !1)))
                }
                d.google_remarketing_only && d.google_enable_display_cookie_match && ed(a, c);
                e = !0
            }
        } catch (k) {}
        return e
    ...
    function Cd(a, b, c, d) {
        ...
        Ad(d, e.length);
        for (var f = 0; f < e.length; f++) dd(a, c, d, Yc(a, b, c, d, 2, e[f]), !0, !0), d.google_conversion_time = d.google_conversion_time + 1
    };
    G = new function() {
        var a = [],
            b = 0,
    ...
    function Dd(a, b, c) {
        ...
        if (2 == c.length) {
            var g = c[0],
                h = c[1];
            0 <= Ha(g, 0, "rmt_tld", g.search(Ia)) && 0 <= Ha(g, 0, "ipr", g.search(Ia)) && !h.match(Fa)[6] && (h += Ga(g), c[1] = D(h, "rmt_tld", "1"))
        }
    ...
    for (var Z; V.length && (Z = V.shift());) V.length || void 0 === Dd ? Y[Z] && Y[Z] !== Object.prototype[Z] ? Y = Y[Z] : Y = Y[Z] = {} : Y[Z] = Dd;
